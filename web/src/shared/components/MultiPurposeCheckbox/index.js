...
export class Select extends Component {
  ...
  componentDidMount() {
    if (!this.props.placeholder) {
      this.setState({
        values: [this.props.options[0].name]
      });
    }
  }
  onFocus = () => {
          ...
          if (multiple) {
            this.setState(prevState => {
              ...
              if (focusedValue !== -1) {
                ...
                const value = options[focusedValue].name;
        ...
        this.setState(prevState => {
          ...
          if (focusedValue < options.length - 1) {
            ...
            if (multiple) {
              ...
              return {
                values: [options[focusedValue].name],
                focusedValue
              };
            }
          }
  ...
  onClick = () => {
    // this.props.selectedValues(this.state.values);
    this.setState(prevState => ({
      isOpen: !prevState.isOpen
    }));
  };
  ...
  onDeleteOption = e => {
    ...
    this.setState(prevState => {
      ...
      // this.props.handleMultipleCheckbox(values);
      return { values };
    });
  };
