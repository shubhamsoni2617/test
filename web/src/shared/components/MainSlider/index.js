...
export class MainSlider extends React.Component {
    ...
    playAutoSlider(currSlide){
        ...
        this.state.height = document.getElementsByClassName("slider-single")[0].clientHeight;
            let interval = setInterval(function counter() {
                ...
                if(initInterval){
                    slideCounter = currSlide != slideTotal ? self.state.slideCurrent + 1 : 0;
                    initInterval = false;
                }else{
                    slideCounter = self.state.slideCurrent != slideTotal ? self.state.slideCurrent + 1 : 0
                }
        ...
        return (
            <div>
                ...
                <div className="thumbnail-content">
                        ...
                        {
                            thumbnail && thumbnail.map((slider, index) => {
                                return (<div className={`thumbnail-single ${slider.class}`} key={index}>
