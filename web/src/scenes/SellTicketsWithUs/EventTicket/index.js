      ...
      <div className="container">
        <div className="event-list">
          <div className="event-list-icon">
            <Image type="Small" src={eventIcon1} alt="Years-icon" />
          ...
          <div className="event-list-icon">
            <Image type="Small" src={eventIcon2} alt="tickets-icon" />
            <div className="year-content">
              <span>{tickets}</span>
              <p>Tickets</p>
            </div>
          ...
          <div className="event-list-icon">
            <Image type="Small" src={eventIcon3} alt="Partners-icon" />
            <div className="year-content">
          ...
          <div className="event-list-icon">
            <Image type="Small" src={eventIcon4} alt="Events-icon" />
            <div className="year-content">
              <span>{events}</span>
              <p>Events</p>
            </div>
