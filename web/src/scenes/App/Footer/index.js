    ...
    return (        
        ...
        <div className="container-fluid">
            <div className="st-footer-top">
                ...
                <div className="st-footer-links st-helpful-links">
                    <h3>Helpful Links</h3>
