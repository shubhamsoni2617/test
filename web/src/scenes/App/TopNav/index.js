               ...
               <div className="row">
                  <div className="top-header">
                                 ...
                                 <div className="recently-search">
                                    ...
                                    <ul>
                                       <li className="active">
                                          ...
                                          <a href="javascript:void(0);" className="search-listing-close-btn"><img src="assets/images/close-blue-color.svg" alt="" /></a>
                                       </li>
                                       <li>
                                       ...
                                       <li>
                                          ...
                                          <a href="javascript:void(0);" className="search-listing-close-btn">
                     ...
                     <div className="top-header-right">
                        <ul>
                           <li className="user-icon"><a href="javascript:void(0);"><img src="assets/images/man.svg"
                              ...
                              <div className="my-cart-popup">
                                 <div className="my-cart-wrapper">
                                    <div className="cart-head">
                                       <h3>My Cart (5)</h3>
                                       <a href="javascript:void(0);" className="cart-close">X</a>
                                    </div>
                           ...
                           <li className="ticket-withus"><a href="javascript:void(0);">Ticket With Us</a></li>
                        </ul>
                     </div>
                  </div>
                  <nav className="bottom-header">
                           ...
                           <li className="has-submenu">
                              ...
                              <div className="submenu">
                                    ...
                                    <div className="events-listing">
                                       <ul>
                                          ...
                                          <li className="seeall-veneus">
                                             <a className="seeall-btn" href="javascript:void(0);">See All Venues <img src="assets/images/right-arrow.svg" alt="" className="" /></a>
                                          </li>
                                       </ul>
                                 ...
                                 <div className="see-all-evevts">
                                    <a href="javascript:void(0);" className="seeall-btn">See All Events 
                     ...
                     <div className="bottom-header-right">
                        <ul>
                           ...
                           <li><a href="javascript:void(0);">More<span className="dropdown-icon">
                               <img
                  ...
                  <div className="responsive-nav-links">
                     <a href="javascript:void(0);" className="responsive-nav-close">X</a>
                     <ul className="user-details">
                        <li className="user-icon"><a href="javascript:void(0);">
                     ...
                     <ul>
                        <li className="has-submenu"><a href="javascript:void(0);">Our Company</a></li>
                        <li className="has-submenu"><a href="javascript:void(0);">Helpful Links</a></li>
                        <li className="has-submenu"><a href="javascript:void(0);">For Business</a></li>
                        <li className="has-submenu"><a href="javascript:void(0);">Stay Connected</a></li>
                     </ul>
                     <ul>
